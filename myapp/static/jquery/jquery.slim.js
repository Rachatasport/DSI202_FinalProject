...
( function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// e.g. var jQuery = require("/static/jquery")(window);
		// See ticket #14549 for more info.
		module.exports = global.document ?
			factory( global, true ) :
			function( w ) {
				if ( !w.document ) {
					throw new Error( "/static/jquery requires a window with a document" );
				}
				return factory( w );
			};
	} else {
...
jQuery.extend( {
	...
	expando: "/static/jquery" + ( version + Math.random() ).replace( /\D/g, "" ),
...
jQuery.Deferred.exceptionHook = function( error, stack ) {
	...
	if ( window.console && window.console.warn && error && rerrorNames.test( error.name ) ) {
		window.console.warn( "/static/jquery.Deferred exception: " + error.message, error.stack, stack );
	}
};
